# Vocabulary Tooltips + Resources Cleanup Report

## Vocabulary
- Added hover/focus definition popups to vocabulary tags across the site.
- Added title text and keyboard focus support for vocabulary terms.

## Resources page cleanup
- Removed course-specific ADM notebook card from the general Resources page.
- Removed AED Unit 0 course-specific resource section from the general Resources page.
- Removed POE/POE course-specific resource section from the general Resources page.
- Kept general templates and reference guides on the Resources page.

## Course-specific resource placement
- Added ADM Digital Engineering Notebook to the ADM course page.
- Added IED Unit 0 startup resources to the IED Unit 0 page.
- POE resources were already present on the POE course page.

## QA

- vocab pages updated: 4
- vocab tooltips added: 47
- tooltip css added: True
- ADM notebook removed from resources page: True
- AED Unit 0 section removed from resources page: True
- POE section removed from resources page: True
- ADM resource kept on ADM page: True
- IED Unit 0 resources kept on Unit 0 page: True
