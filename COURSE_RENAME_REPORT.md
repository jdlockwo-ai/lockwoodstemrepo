...
| Principles of Engineering | POE | POE | `courses/poe/` |
...
- `POE_...` for POE resources

Examples:

- `AED_Unit0_Student_Deck.pdf`
- `AED_Syllabus_2026_2027.pdf`
- `POE_Project_Brief_Packet.pdf`
- `POE_Aerospace_Rover_Systems_Engineering_Build_Guide.pdf`
- `LockwoodSTEM_POE_Common_Template_Pack.zip`
